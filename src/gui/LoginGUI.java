...
public class LoginGUI extends JInternalFrame {
	...
	private JLabel lblUser=new JLabel("ID Pengguna");
	private JLabel lblPass=new JLabel("Sandi Pengguna");
	...
	public LoginGUI(String judul, int posX, int posY, int width,
		...
		JLabel lblJudul = new JLabel("<html><h2><font color='white'>LOGIN FORM</font></h2></html>");
